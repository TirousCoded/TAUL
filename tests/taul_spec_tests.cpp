...
// the return value of taul::taul_spec, and testing its lexing/parsing 
// behaviour, but not otherwise asserting what taul::taul_spec must return
...
class TAULSpecTests : public testing::Test {
protected:
...
TEST_F(TAULSpecTests, LoadsSuccessfully) {
    ASSERT_TRUE(gram);
}


TEST_F(TAULSpecTests, LPRs) {
    ASSERT_TRUE(gram);
...
TEST_F(TAULSpecTests, IDENTIFIER) {
...
TEST_F(TAULSpecTests, WHITESPACE) {
...
TEST_F(TAULSpecTests, Syntax_EmptySourceFile) {
    taul::source_code input{};

    ASSERT_TRUE(input.add_file(std::filesystem::current_path() / "support\\taul_spec_tests_1.taul", lgr));
...
TEST_F(TAULSpecTests, Syntax_BasicTopLevel) {
    taul::source_code input{};

    ASSERT_TRUE(input.add_file(std::filesystem::current_path() / "support\\taul_spec_tests_2.taul", lgr));
...
TEST_F(TAULSpecTests, Syntax_ ## _RULE_) {\
    taul::source_code input{};\
\
...
TEST_F(TAULSpecTests, Syntax_Sequence) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_LookAhead) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_LookAheadNot) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Not) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Suffixes) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Suffixes_NotablePrecedence_A) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Suffixes_NotablePrecedence_B) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Suffixes_NotablePrecedence_C) {
    taul::source_code input{};
...
TEST_F(TAULSpecTests, Syntax_Alts) {
    taul::source_code input{};
